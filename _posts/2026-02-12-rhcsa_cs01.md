...
- VMware의 현재 설정 확인하는 법:
	- VMware 우측하단의 ![image](attachments/Pasted%20image%2020260212201024.png) 아이콘을 누른다.
	- ![image](attachments/Pasted%20image%2020260212201009.png)
	- NAT으로 돼있는 걸 확인.
...
2. NAT이면 외부인터넷이 되는 환경임은 맞다. 그럼 다음으로 NAT에서 지정한 가상 범위가 내 설정값과 맞는지 확인한다.
	...
	- ![image](attachments/Pasted%20image%2020260212201449.png)
	- ![image](attachments/Pasted%20image%2020260212201523.png)
