--- layout: post title: "[CS 공부] struct와 오버라이딩" date: '2022-04-18T08:00:00.000-07:00' author: 가도 tags: - CS공부 modified\_time: '2022-08-12T00:53:02.306-07:00' blogger\_id: tag:blogger.com,1999:blog-778891705567453961.post-6084911722895772311 blogger\_orig\_url: https://sealbinary.blogspot.com/2022/08/cs-struct.html ---
...
void main(){ int param = 1;SomeFunc(param);}...void SomeFunc(int param){ param = 2;}
...
class Animal{public void Eat(){ }}class Lion : Animal{new public void Eat(){ } //new 한정자 사용}class Program {public static void main(int[] args){ Animal a1 = new Animal(); Animal a2 = new Lion(); Lion l1 = new Lion(); a1.Eat(); a2.Eat(); l1.Eat();}}
...
class Animal{public virtual void Eat(){ } //virtual 키워드 사용}class Lion : Animal{public override void Eat(){ } //override 키워드 사용}class Program {public static void main(int[] args){ Animal a1 = new Animal(); Animal a2 = new Lion(); Lion l1 = new Lion(); a1.Eat(); a2.Eat(); l1.Eat();}}
