--- layout: post title: "[C# 공부] C#의 엔트리 포인트, Console.Read()와 Console.ReadLine()의 차이점" date: '2022-06-10T08:00:00.001-07:00' author: 가도 tags: - C# modified\_time: '2022-08-12T00:53:38.562-07:00' blogger\_id: tag:blogger.com,1999:blog-778891705567453961.post-1011547443174258950 blogger\_orig\_url: https://sealbinary.blogspot.com/2022/06/c-c-consoleread-consolereadline.html ---
...
class Program{public static void Main(){//여기서부터 시작}}
...
public class Program{public static void Main(){//여기서부터 시작}}

​

Main 함수의 리턴형과 인자를 마음대로 바꾸어도 영향을 받지 않는다.

class Program{public static int Main(string[] args){//여기서부터 시작return 0;}}

클래스 이름을 마음대로 바꾸어도 상관없다.

class Chicken{public static void Main(){//여기서부터 시작}}
...
int a = Console.Read();Console.Read();int b = Console.Read();Console.WriteLine(a+b):
